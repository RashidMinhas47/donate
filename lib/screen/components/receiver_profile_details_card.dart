...
class SingleReceiverProfileDetailedCard extends StatelessWidget {
  const SingleReceiverProfileDetailedCard(
      {super.key,
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          SvgPicture.asset(AppSvg.whatsappText ,height: 30,),
                          ...
                          SvgPicture.asset(AppSvg.phoneLogo,height:30),
                          Divider(color: kPrimaryColor.withOpacity(0.3),thickness: 1, indent: size.width*0.2,endIndent: size.width*0.2,),
            ...
            children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                          itemCount: cardData[IMAGEURL].length, itemBuilder: (context,index)=>Container(
              ...
              Center(
                child: TextButton(style: TextButton.styleFrom(
                  ...
                  showGlassmorphismPopup(context,size);
                }, child: Text(
                  'send it',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.quicksand(
