      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // autogroup3hevs1w (TgBE49gyFcNAjnsfUq3hEV)
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0.78 * 1, 0 * 1, 0 * 1, 27 * 1),
                    width: 379 * 1,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          // meetourteamjQq (148:486)
                          margin:
                              EdgeInsets.fromLTRB(0 * 1, 0 * 1, 0 * 1, 5 * 1),
                          child: Text(
                            'Meet our team',
                        ...
                        Container(
                          // loremipsumissimplydummytextoft (148:487)
...
List<Map<String, dynamic>> memberCardInfo = [
  ...
  },
  {
    ...
    JOBDESCRIPTION:
        "As the founder and marketing expert at Donate, I lead our mission to revolutionize charitable giving. Through strategic campaigns and innovative outreach, we connect donors with causes they care about. Join us in making a difference, one donation at a time.",
    IMAGEURL: AppImages.profilePic,
  },
  {
    NAME: 'JAHANGIR ALI',
